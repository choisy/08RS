...
```{r cache_output_all_cont, eval = T, cache = TRUE}
...
```{r cache_output_sev_cont, eval = T, cache = TRUE}
...
```{r cache_output_nonsev_cont, eval = T, cache = TRUE}
...
```{r cache_output_sev_nonsev, eval = T, cache = TRUE}
...
```{r cache_output_EV71_cont, eval = T, cache = TRUE}
...
```{r cache_output_nonEV71_cont, eval = T, cache = TRUE}
...
```{r cache_output_EV71_nonEV71, eval = T, cache = TRUE}
...
```{r cache_output_lesions_cont, eval = T, cache = TRUE}
...
```{r cache_output_nolesions_cont, eval = T, cache = TRUE}
