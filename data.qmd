...
plot_score_distr <- function(df) {
  opar <- par(mfrow = c(6, 3), cex = 1, plt = c(.2, .95, .3, .94))
  df |>
...
#scores <- c("MD1ISS", "MD2ISS", "MD3ISS", "AC1ISS", "AC2ISS", "BAL1ISS", "BAL2ISS",
#            "BAL3ISS", "SCALESCORE_CS", "SCALESCORE_RC", "SCALESCORE_EC",
#            "SCALESCORE_FM", "SCALESCORE_GM")

scores <- c("MD1", "MD2", "MD3", "AC1", "AC2", "BAL1", "BAL2", "BAL3",
            "CS", "RC", "EC", "FM", "GM")
```
