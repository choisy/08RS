...
```{r}
ABC <- CRF08RS$ABC |> 
  mutate(MD1  = map2_dbl(map2_dbl(MD1PreferT1, MD1PreferT2, min2),
                         map2_dbl(MD1NonT1, MD1NonT2, min2), mean2),
         MD2  = map2_dbl(zero2NA(MD2T1), zero2NA(MD2T2), min2),
         MD3  = map2_dbl(zero2NA(MD3T1), zero2NA(MD3T2), min2),
         AC1  = AC1Trials, 
         AC2  = AC2Trials,
         BAL1 = map2_dbl(map2_dbl(BAL1RT1, BAL1RT2, max3),
                         map2_dbl(BAL1LT1, BAL1LT2, max3), mean2),
         BAL2 = map2_dbl(BAL2T1, BAL2T2, max3),
         BAL3 = map2_dbl(BAL3T1, BAL3T2, max3),
         across(DateTested, as.Date)) |> 
  select(ParNo, DateTested, MD1, MD2, MD3, AC1, AC2, BAL1, BAL2, BAL3) |>
  make_time_points() |>
